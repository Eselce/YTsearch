...
function clearObj(obj, keepFilter = null) {  // slow, but clean and straight forward, can be used for constant objects
    const __OBJ = (obj || { });
    const __FILTER = (keepFilter || keepNothing);
...
function clearObjFast(obj, keepFilter = null) {  // fast, better version of obj = { }, cannot be used for constant objects
